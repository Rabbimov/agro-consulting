...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-16 pt-[120px] dark:bg-gray-dark md:pb-[110px] md:pt-[200px] xl:pb-[150px] xl:pt-[260px] 2xl:pb-[180px] 2xl:pt-[320px]"
      >
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[900px] text-center">
                ...
                <p className="mb-12 text-sm !leading-relaxed text-gray-100  sm:text-base md:text-lg">
                  Добро пожаловать на сайт фирмы Agro consulting global,
                  компетентного специалиста в сфере делового туризма. Нам очень
                  важно, что бы вы получали от сотрудничества с нами только
                  положительные эмоции. Мы любим заботиться о своих клиентах
                </p>
              </div>
            </div>
          </div>
