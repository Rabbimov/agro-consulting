        ...
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                title="Экскурсия в Польша по сельскому хозяйству"
                paragraph="С этой целью недавно была организована специальная экскурсия в Польша. Основной целью поездки было изучение сельскохозяйственных технологий, современных машин и передовых методов, а также адаптация международного опыта под наши условия."
                mb="44px"
              />
