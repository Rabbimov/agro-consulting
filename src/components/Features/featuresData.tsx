...
const featuresData: Feature[] = [
  {
    ...
    title: "Встречи",
    paragraph: "корпоративные встречи, презентации, переговоры.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Стимулы",
    paragraph: "поощрительные или мотивационные туры и программы.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Конференции",
    paragraph: "конференции, конгрессы, съезды, форумы, семинары.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Выставки",
    paragraph: "выставки, имиджевые мероприятия.",
  },
  {
    id: 1,
    icon: (
      <svg
        ...
        className="relative z-[1] h-[70%] w-[70%] fill-current"
      >
    ...
    paragraph:
      "Германия занимает одно из первых мест в списке самых посещаемых стран Европы.",
  },
  {
    id: 1,
    icon: (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="lucide lucide-factory h-[70%] w-[70%] fill-current"
      >
